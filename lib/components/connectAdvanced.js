...
store, selectorFactory) {
  ...
  return function wrapWithConnect(wrappedObject) {
    invariant((typeof wrappedObject === 'undefined' ? 'undefined' : _typeof(wrappedObject)) == 'object' || typeof wrappedObject == 'function', 'You must pass a component to the function returned by ' + (methodName + '. Instead received ' + JSON.stringify(wrappedObject)));
